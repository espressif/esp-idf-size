...
def main() -> None:
    ...
    parser.add_argument('--archives', action='store_true', help='Print per-archive sizes.')
    ...
    parser.add_argument(
        '--archive-details', '--archive_details', metavar='ARCHIVE_NAME', help='Print detailed symbols per archive.'
    )

    parser.add_argument('--files', action='store_true', help='Print per-file sizes.')

    parser.add_argument('--diff', metavar='MAP_FILE', help='Compare sizes with another project.')

    parser.add_argument('--no-abbrev', action='store_true', help='Do not abbreviate section and file names.')
    ...
    parser.add_argument('--show-unused', action='store_true', help='Show unused memory types and sections.')

    parser.add_argument('--show-unchanged', action='store_true', help='Show unchanged items for --diff operation.')
    ...
    parser.add_argument(
        '-d', '--debug', action='store_true', help=('Print debug information. Messages are printed to stderr.')
    )
    ...
    parser.add_argument('--sort-diff', action='store_true', help=('Sort entries based on diff value instead of size.'))
    ...
    parser.add_argument('--no-color', action='store_true', help=('Disable ANSI color escape sequences.'))
    ...
    parser.add_argument('--doc', action=DocAction, nargs=0, help=('Display more comprehensive documentation.'))
