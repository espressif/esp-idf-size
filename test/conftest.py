...
@pytest.fixture
def artifacts_legacy() -> Path:
    # Return the path to the artifacts for the legacy version located within the repository.
    artifacts_path = Path(__file__).resolve().parent / 'legacy' / 'artifacts'
